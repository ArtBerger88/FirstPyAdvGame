        ...
        if answer == "pry":
            ...
            if answer == "pry":
                ...
                if answer == "thru":
                    ...
                    print("Patience you covet, Found me you have, in order congragulations is!!!! You study under the great Grandmaster Yoda for years and become a far greater jedi than i. He grants you the rank of Master!!!!YOU WIN")
                else:
                    exit1()
            else:
                exit1()
